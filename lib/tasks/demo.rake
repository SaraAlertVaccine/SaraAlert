...
namespace :demo do
  ...
  task setup: :environment do
    ...
    phe11 = User.create(email: 'cbezold2@mitre.org', password: '1234567ab!', role: Roles::PUBLIC_HEALTH_ENROLLER, jurisdiction: jurisdictions[:usa], force_password_change: false, authy_enabled: false, authy_enforced: false, api_enabled: true)
