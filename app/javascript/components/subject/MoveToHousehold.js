      ...
      <Modal size="lg" show centered onHide={toggle}>
        ...
        <Modal.Body>
          <Form>
            <Row>
              <Form.Group as={Col}>
                <Form.Label className="nav-input-label">Select The New Recipient That Will Respond For The Current Recipient</Form.Label>
                <Form.Label size="sm" className="nav-input-label">
                  Note: The current recipient will be moved into the selected recipient&apos;s household
                </Form.Label>
