...
describe('MonitoringStatus', () => {
  ...
  it('Properly renders radio buttons for HoH', () => {
    ...
    expect(modalBody.find('#apply_to_household_yes').prop('label')).toEqual('This recipient and all household members (this will turn Continuous Exposure OFF for all household members)');
  });
